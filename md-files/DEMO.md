...
- *"Mid-term collateral crash?"* → Maturity-only checks, and PRICED for it: the gap-risk put (PRICING.md) is ~290bps of the rate at 150%. Continuous margining via scheduled sentinel is roadmap — and the pricing table quantifies exactly how many bps it saves.
